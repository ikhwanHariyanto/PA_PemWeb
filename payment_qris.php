        ...
        <div class="payment-content">
            ...
            <div class="qris-payment-box">
                ...
                <div class="payment-actions">
                    <a href="<?php echo $wa_link; ?>" class="btn-confirm-wa" id="waButton">
                ...
                <div class="payment-note">
                    <p><strong>Catatan:</strong> Setelah klik tombol di atas, WhatsApp akan terbuka. Kirim bukti pembayaran Anda, lalu halaman akan otomatis kembali ke beranda dalam 3 detik.</p>
                </div>
            </div>
        </div>
    </div>
...
<script>
// Auto redirect ke beranda setelah klik WA
document.getElementById('waButton').addEventListener('click', function(e) {
    ...
    // Show toast
    if (window.showToast) {
        showToast('WhatsApp terbuka! Kirim bukti pembayaran, lalu Anda akan diarahkan ke beranda...', 'success', 3000);
    }
